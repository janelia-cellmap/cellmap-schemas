...
from cellmap_schemas.annotation import AnnotationArray, AnnotationArrayAttrs, AnnotationGroup, AnnotationGroupAttrs, CropGroup, CropGroupAttrs, SemanticSegmentation, wrap_attributes
import numpy as np
import zarr
...
def test_cropgroup():
    ...
    crop_group = CropGroup(
        members=ann_groups, 
        attrs=wrap_attributes(crop_group_attrs)
        )
